...
path="/home/vindhya/Documents/Siamese_Project/Dataset/"+dataset_name+classf
dest="/home/vindhya/Documents/Siamese_Project/Dataset/"+dataset_name+classf+"_patches400/"
...
for file in files:
	...
	for i in range(0,row-window,np.int(window/slide)):
		for j in range(0,col-window,np.int(window/slide)):
			...
			ratio_white_pixel=float(pixel_and_count*100/(400*400))
